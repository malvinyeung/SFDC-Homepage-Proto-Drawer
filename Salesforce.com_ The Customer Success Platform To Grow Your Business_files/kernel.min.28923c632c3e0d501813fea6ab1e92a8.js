...
CQ_Analytics.Utils.loadTeaserElement=function(b,h){var a=function(l){if(l&&l!=""){var k=$CQ(l).css("display","none");
var j=$CQ("#"+h)[0];
$CQ("#"+h).html(k);
...
var g=function(){if(CQ_Analytics.Utils.teasersCache&&CQ_Analytics.Utils.teasersCache[b]){a(CQ_Analytics.Utils.teasersCache[b])
}else{CQ_Analytics.Utils.teasersLoading=CQ_Analytics.Utils.teasersLoading||{};
...
CQ_Analytics.SFDCSegmentUtils.init=function(){var a=(typeof vp!=="undefined"&&vp.isCustomer())?"customer":"prospect",c=location.href,b=CQ.shared.HTTP.getParameter(c,"forceProfile");
if(b){a=b
...
if(!CQ_Analytics.DemandbaseStore.data){var c=document.location.protocol,b=c+"//api.demandbase.com/api/v2/ip.json?token=09dd7a8bed725339af3ce985f86800730b42b5cf";
$.get(b).done(function(d){CQ_Analytics.DemandbaseStore.data=d;
a()
})
}else{a()
}};
