...
p<b.pagingCount;
p++){r=(l.controlNav==="thumbnails")?'<img src="'+b.slides.eq(p).attr("data-thumb")+'"/>':'<a href="#">'+o+"</a>";
b.controlNavScaffold.append('<li class="proto-'+o+'">'+r+"</li>");
o++
...
}},directionNav:{setup:function(){var o=a('<ul class="'+g+'direction-nav"><li class="'+g+'prevli"><a class="'+g+'prev" href="#">'+l.prevText+'</a></li><li class="'+g+'nextli"><a class="'+g+'next" href="#">'+l.nextText+"</a></li></ul>");
